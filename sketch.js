...
let rates ={}; // store the exchange rate as an object

let requestURL = "https://api.exchangerate.host/latest?base=IDR"
...
function convert (val, fromCurr, toCurr){
    ...
    let v1 = v.toFixed(2);
    return v1 == 0 ? v.toFixed(5) : v1;
}//convert function convert value from one currency to other
...
selects.forEach(s => s.addEventListener('changed', displayRate));
